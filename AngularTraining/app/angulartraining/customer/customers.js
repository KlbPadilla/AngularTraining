(function () {
    ...
    angular.module('app').controller(controllerId, ['$scope', '$modal', 'common', 'dataservice', 'applicationData', customers]);
    function customers($scope, $modal, common, dataservice, applicationData) {
