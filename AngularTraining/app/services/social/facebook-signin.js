              ...
              function ($q, $rootScope, $timeout, $window) {
                      ...
                      NgFacebook.prototype[name] = function () {
                          ...
                          $timeout(function () {
                              ...
                              loadDeferred.promise.then(function () {
                                  $window.FB[name].apply($window.FB, args);
                              }, function () {
                  ...
                  NgFacebook.prototype.subscribe = function () {
                      ...
                      $timeout(function () {
                          // Call when loadDeferred be resolved, meaning Service is ready to be used
                          loadDeferred.promise.then(function () {
                              $window.FB.Event.subscribe.apply($window.FB, args);
                          }, function () {
                              throw 'Facebook API could not be initialized properly';
                          });
                      });
                  ...
                  NgFacebook.prototype.unsubscribe = function () {
                      ...
                      $timeout(function () {
                          ...
                          loadDeferred.promise.then(
                            function () {
                                $window.FB.Event.unsubscribe.apply($window.FB, args);
                            },
                            function () {
                                throw 'Facebook API could not be initialized properly';
                            }
            ...
            $window.fbAsyncInit = function () {
                ...
                $timeout(function () {
                    ...
                    angular.forEach({
                        ...
                        $window.FB.Event.subscribe(name, function (response) {
                            $timeout(function () {
                    ...
                    loadDeferred.resolve($window.FB);
